...
def parse_global_args():
    ...
    parser.add_argument("--is_attack_benchmark", action='store_true')
    parser.add_argument("--plan_attack", action='store_true')
    parser.add_argument("--steal_privacy_type", type=str, default = 'privacy_key', help="Path to the normal tools info file")

    parser.add_argument("--action_attack", action='store_true')
    parser.add_argument("--know_privacy_key", action='store_true')
    ...
    parser.add_argument("--attack_tool_type", type=str, required=True, choices=['original', 'target', 'untarget'], help="The type of attack tool to use")
    ...
    parser.add_argument('--task_num', type=int, default=5, help="The task number for an agent to run")
    parser.add_argument('--run_tools_num', type=int, default=2, help="The task number for an agent to run")
    parser.add_argument('--steal_parmas_num', type=int, default=2, help="The task number for an agent to run")
    parser.add_argument('--parallel_num', type=int, default=2, help="The task number for an agent to run")
