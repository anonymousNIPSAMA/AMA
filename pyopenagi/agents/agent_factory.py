...
class AgentFactory:
    ...
    def activate_agent(self, agent_name, task_input, args, attacker_tool,vector_db, agg,  **kwargs):
    ...
    def run_agent(self, agent_name, task_input, args, attacker_tool, vector_db, agg,**kwargs):
